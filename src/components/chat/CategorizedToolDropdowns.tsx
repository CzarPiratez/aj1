...
export function CategorizedToolDropdowns({ 
  ...
  const handleToolClick = (tool: Tool) => {
    ...
    if (isActive) {
      // Execute the tool action directly - this should auto-submit immediately
      tool.action();
    } else {

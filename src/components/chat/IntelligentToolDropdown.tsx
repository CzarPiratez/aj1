...
interface IntelligentToolDropdownProps {
...
export function IntelligentToolDropdown({ 
  flags, 
  onToolAction, 
  onInactiveToolClick, 
  disabled = false 
}: IntelligentToolDropdownProps) {
        ...
        <div className="flex items-center justify-between w-full">
          <h4 
            ...
            style={{ 
              ...
              fontWeight: '450' // Set to exactly 450
            }}
          >
            {tool.label}
          </h4>
        ...
        {toolCategories.map((category, categoryIndex) => (
          <React.Fragment key={category.id}>
            <DropdownMenuLabel 
              ...
              style={{ 
                color: '#66615C',
                fontWeight: '450' // Set to exactly 450 for category labels too
              }}
            >
              {category.label}
            </DropdownMenuLabel>

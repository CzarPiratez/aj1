/*
  ...
  2. Security
    ...
    - Users can insert and read their own error logs
    - Anonymous users can insert error logs for client-side tracking
    - Service role has full access for admin purposes

  3. Performance
    - Add indexes on user_id, created_at, and error_type for efficient querying
*/

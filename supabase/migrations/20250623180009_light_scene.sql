/*
  ...
  2. Security
    ...
    - Add policies for authenticated users to manage their own error logs
    - Add policies for service role to manage all error logs
...
-- RLS Policies with conflict prevention
